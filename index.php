...
<section class="page__main page__main--popular">
    ...
    <div class="popular container">
        ...
        <div class="popular__posts">
            <?php foreach($one_post as $index): ?>
            <article class="popular__post post <?= $index['type'] ?>">
                <header class="post__header">
                    <h2><?= $index['title'] ?></h2>
                </header>
                <div class="post__main">
                    <?php if ($index['type'] === 'post-quote'): ?>
                    ...
                    <div class="post-photo__image-wrapper">
                        <img src="img/<?= $index['img_url'] ?>" alt="Фото от пользователя" width="360" height="240">
                    </div>
                    <?php elseif ($index['type'] === 'post-video'): ?>
                    ...
                    <?php elseif ($index['type'] === 'post-link'): ?>
                    <!--содержимое для поста-ссылки-->
                    <div class="post-link__wrapper">
                        <a class="post-link__external" href="http://<?= $index['link'] ?>" title="Перейти по ссылке">
                    ...
                    <div class="post__author">
                        <a class="post__author-link" href="#" title="Автор">
                            <div class="post__avatar-wrapper">
                                <img class="post__author-avatar" src="img/<?= $index['avatar'] ?>" alt="Аватар пользователя">
                            </div>
                            <div class="post__info">
                                <b class="post__author-name"><?= $index['name'] ?></b>
